...
float m1,c1,m2,c2,hx,hy,ix,iy,vx,vy,m3,c3,m4,c4;
float x_pos = 0.0f;
float y_pos = 0.0f;
float Z_pos = 0.0f;
float H_pos = 0.0f;
...
void timer(int){
    ...
    y_pos += delta1;
    /////////////////////
    if(H_pos < 8.00f && kanan){
       H_pos += delta2;
    }
    else{
        kanan =false;
    }
    if (H_pos > -1.00f && !kanan){
        H_pos -= delta2;
    }
    else{
        kanan =true;
    ...
    /////////////////////////
    if(Z_pos < 5.00f && kanan1){
       Z_pos += delta3;
    }
    else{
        kanan1 =false;
    }
    if (Z_pos > -1.00f && !kanan1){
        Z_pos -= delta3;
    }
    else{
        kanan1=true;
...
void ngon(int n, float cx, float cy, float radius, float rotAngle){
    ...
    glVertex3f(radius*cos(angle)+ cx,radius*sin(angle)+cy,-50.0);
    for(k=0;k <n;k++){
        angle += angleInc;
        glVertex3f(radius*cos(angle)+cx, radius * sin(angle)+cy,-50.0);
    }
...
glBegin(GL_QUADS);
glColor3f(0,1,0);
glVertex3f(400.0,-10.0,-10.0);
glVertex3f(10.0,-10.0,-10.0);
glVertex3f(10.0,0.0,-10.0);
glVertex3f(400.0,0.0,-10.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(0,1,0);
glVertex3f(400.0,-10.0,-20.0);
glVertex3f(10.0,-10.0,-20.0);
glVertex3f(10.0,0.0,-20.0);
glVertex3f(400.0,0.0,-20.0);
glEnd();
...
glColor3f(1,0,0);
glBegin(GL_POINTS);
glVertex3f(hx,hy,-14.9);
glVertex3f(ix,iy,-14.9);
glEnd();

glBegin(GL_QUADS);
glColor3f(10,0,0);
glVertex3f(-0.0+x_pos,-10.0,-9.0);
glVertex3f(-20.0+x_pos,-10.0,-9.0);
glVertex3f(-20.0+x_pos,0.0,-9.0);
glVertex3f(-0.0+x_pos,0.0,-9.0);
glEnd();
...
glColor3f(10,0,0);
for(i=1; i<2; i++){
    ngon(7,31.0,30,20-(i*0.2),i+y_pos);
}
glEnd();
////RUMPUT
glColor3f(0,1,0);
glBegin(GL_TRIANGLES);
glVertex3f(-305.0+H_pos,0.0,-200.0);
glVertex3f(-301.0-Z_pos,0.-10,-200.0);
glVertex3f(-309.0,-10.0,-200.0);
glEnd();

glColor3f(0,1,0);
glBegin(GL_TRIANGLES);
glVertex3f(-297.0+H_pos,0.0,-200.0);
glVertex3f(-293.0-Z_pos,0.-10,-200.0);
glVertex3f(-301.0,-10.0,-200.0);
glEnd();
///////////////////////////////
glColor3f(0,1,0);
glBegin(GL_TRIANGLES);
glVertex3f(-289.0+H_pos,0.0,-200.0);
glVertex3f(-286.0-Z_pos,0.-10,-200.0);
glVertex3f(-293.0,-10.0,-200.0);
glEnd();

glColor3f(0,1,0);
glBegin(GL_TRIANGLES);
glVertex3f(-281.0+H_pos,0.0,-200.0);
glVertex3f(-278.0-Z_pos,0.-10,-200.0);
glVertex3f(-286.0,-10.0,-200.0);
glEnd();
...
glVertex3f(32.0,30.0,-57.0);
glVertex3f(30.0,30.0,-57.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(0,1,0);
glVertex3f(30.0,27.0,-50.0);
glVertex3f(32.0,27.0,-50.0);
...
glBegin(GL_QUADS);
glColor3f(0,1,0);
glVertex3f(30.0,27.0,-55.0);
glVertex3f(32.0,27.0,-55.0);
glVertex3f(32.0,30.0,-55.0);
glVertex3f(30.0,30.0,-55.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,200.0,-340.0);
glVertex3f(200.0,200.0,-340.0);
glVertex3f(200.0,200.0,-280.0);
glVertex3f(180.0,200.0,-280.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(200.0,200.0,-340.0);
glVertex3f(220.0,200.0,-345.0);
glVertex3f(220.0,200.0,-285.0);
glVertex3f(200.0,200.0,-280.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(220.0,200.0,-345.0);
glVertex3f(240.0,200.0,-355.0);
glVertex3f(240.0,200.0,-295.0);
glVertex3f(220.0,200.0,-285.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(240.0,200.0,-355.0);
glVertex3f(260.0,200.0,-370.0);
glVertex3f(260.0,200.0,-310.0);
glVertex3f(240.0,200.0,-295.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(260.0,200.0,-370.0);
glVertex3f(280.0,200.0,-395.0);
glVertex3f(280.0,200.0,-335.0);
glVertex3f(260.0,200.0,-310.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(280.0,200.0,-395.0);
glVertex3f(300.0,200.0,-425.0);
glVertex3f(300.0,200.0,-365.0);
glVertex3f(280.0,200.0,-335.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,150.0,-340.0);
glVertex3f(200.0,150.0,-340.0);
glVertex3f(200.0,150.0,-280.0);
glVertex3f(180.0,150.0,-280.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(200.0,150.0,-340.0);
glVertex3f(220.0,150.0,-345.0);
glVertex3f(220.0,150.0,-285.0);
glVertex3f(200.0,150.0,-280.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(220.0,150.0,-345.0);
glVertex3f(240.0,150.0,-355.0);
glVertex3f(240.0,150.0,-295.0);
glVertex3f(220.0,150.0,-285.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(240.0,150.0,-355.0);
glVertex3f(260.0,150.0,-370.0);
glVertex3f(260.0,150.0,-310.0);
glVertex3f(240.0,150.0,-295.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(260.0,150.0,-370.0);
glVertex3f(280.0,150.0,-395.0);
glVertex3f(280.0,150.0,-335.0);
glVertex3f(260.0,150.0,-310.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(280.0,150.0,-395.0);
glVertex3f(300.0,150.0,-425.0);
glVertex3f(300.0,150.0,-365.0);
glVertex3f(280.0,150.0,-335.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,100.0,-340.0);
glVertex3f(200.0,100.0,-340.0);
glVertex3f(200.0,100.0,-280.0);
glVertex3f(180.0,100.0,-280.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(200.0,100.0,-340.0);
glVertex3f(220.0,100.0,-345.0);
glVertex3f(220.0,100.0,-285.0);
glVertex3f(200.0,100.0,-280.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(220.0,100.0,-345.0);
glVertex3f(240.0,100.0,-355.0);
glVertex3f(240.0,100.0,-295.0);
glVertex3f(220.0,100.0,-285.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(240.0,100.0,-355.0);
glVertex3f(260.0,100.0,-370.0);
glVertex3f(260.0,100.0,-310.0);
glVertex3f(240.0,100.0,-295.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(260.0,100.0,-370.0);
glVertex3f(280.0,100.0,-395.0);
glVertex3f(280.0,100.0,-335.0);
glVertex3f(260.0,100.0,-310.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(280.0,100.0,-395.0);
glVertex3f(300.0,100.0,-425.0);
glVertex3f(300.0,100.0,-365.0);
glVertex3f(280.0,100.0,-335.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,50.0,-340.0);
glVertex3f(200.0,50.0,-340.0);
glVertex3f(200.0,50.0,-280.0);
glVertex3f(180.0,50.0,-280.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(200.0,50.0,-340.0);
glVertex3f(220.0,50.0,-345.0);
glVertex3f(220.0,50.0,-285.0);
glVertex3f(200.0,50.0,-280.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(220.0,50.0,-345.0);
glVertex3f(240.0,50.0,-355.0);
glVertex3f(240.0,50.0,-295.0);
glVertex3f(220.0,50.0,-285.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(240.0,50.0,-355.0);
glVertex3f(260.0,50.0,-370.0);
glVertex3f(260.0,50.0,-310.0);
glVertex3f(240.0,50.0,-295.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(260.0,50.0,-370.0);
glVertex3f(280.0,50.0,-395.0);
glVertex3f(280.0,50.0,-335.0);
glVertex3f(260.0,50.0,-310.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(280.0,50.0,-395.0);
glVertex3f(300.0,50.0,-425.0);
glVertex3f(300.0,50.0,-365.0);
glVertex3f(280.0,50.0,-335.0);
glEnd();
////////////////////////////////////////////////////////////////////////////////////////
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,0.0,-340.0);
glVertex3f(200.0,0.0,-340.0);
glVertex3f(200.0,0.0,-280.0);
glVertex3f(180.0,0.0,-280.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(200.0,0.0,-340.0);
glVertex3f(220.0,0.0,-345.0);
glVertex3f(220.0,0.0,-285.0);
glVertex3f(200.0,0.0,-280.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(220.0,0.0,-345.0);
glVertex3f(240.0,0.0,-355.0);
glVertex3f(240.0,0.0,-295.0);
glVertex3f(220.0,0.0,-285.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(240.0,0.0,-355.0);
glVertex3f(260.0,0.0,-370.0);
glVertex3f(260.0,0.0,-310.0);
glVertex3f(240.0,0.0,-295.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(260.0,0.0,-370.0);
glVertex3f(280.0,0.0,-395.0);
glVertex3f(280.0,0.0,-335.0);
glVertex3f(260.0,0.0,-310.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(280.0,0.0,-395.0);
glVertex3f(300.0,0.0,-425.0);
glVertex3f(300.0,0.0,-365.0);
glVertex3f(280.0,0.0,-335.0);
glEnd();
///////////////////////////////////////////////////////////////////////////////////
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,250.0,-360.0);
glVertex3f(160.0,250.0,-365.0);
glVertex3f(160.0,250.0,-305.0);
glVertex3f(180.0,250.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(160.0,250.0,-365.0);
glVertex3f(140.0,250.0,-375.0);
glVertex3f(140.0,250.0,-315.0);
glVertex3f(160.0,250.0,-305.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(120.0,250.0,-390.0);
glVertex3f(100.0,250.0,-415.0);
glVertex3f(100.0,250.0,-355.0);
glVertex3f(120.0,250.0,-330.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(100.0,250.0,-415.0);
glVertex3f(80.0,250.0,-445.0);
glVertex3f(80.0,250.0,-385.0);
glVertex3f(100.0,250.0,-355.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,200.0,-360.0);
glVertex3f(160.0,200.0,-365.0);
glVertex3f(160.0,200.0,-305.0);
glVertex3f(180.0,200.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(160.0,200.0,-365.0);
glVertex3f(140.0,200.0,-375.0);
glVertex3f(140.0,200.0,-315.0);
glVertex3f(160.0,200.0,-305.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(120.0,200.0,-390.0);
glVertex3f(100.0,200.0,-415.0);
glVertex3f(100.0,200.0,-355.0);
glVertex3f(120.0,200.0,-330.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(100.0,200.0,-415.0);
glVertex3f(80.0,200.0,-445.0);
glVertex3f(80.0,200.0,-385.0);
glVertex3f(100.0,200.0,-355.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,150.0,-360.0);
glVertex3f(160.0,150.0,-365.0);
glVertex3f(160.0,150.0,-305.0);
glVertex3f(180.0,150.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(160.0,150.0,-365.0);
glVertex3f(140.0,150.0,-375.0);
glVertex3f(140.0,150.0,-315.0);
glVertex3f(160.0,150.0,-305.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(140.0,150.0,-375.0);
glVertex3f(120.0,150.0,-390.0);
glVertex3f(120.0,150.0,-330.0);
glVertex3f(140.0,150.0,-315.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(120.0,150.0,-390.0);
glVertex3f(100.0,150.0,-415.0);
glVertex3f(100.0,150.0,-355.0);
glVertex3f(120.0,150.0,-330.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(100.0,150.0,-415.0);
glVertex3f(80.0,150.0,-445.0);
glVertex3f(80.0,150.0,-385.0);
glVertex3f(100.0,150.0,-355.0);
glEnd();
//////////////////////////////////////////////////////////////////////////////////
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,100.0,-360.0);
glVertex3f(160.0,100.0,-365.0);
glVertex3f(160.0,100.0,-305.0);
glVertex3f(180.0,100.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(160.0,100.0,-365.0);
glVertex3f(140.0,100.0,-375.0);
glVertex3f(140.0,100.0,-315.0);
glVertex3f(160.0,100.0,-305.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(140.0,100.0,-375.0);
glVertex3f(120.0,100.0,-390.0);
glVertex3f(120.0,100.0,-330.0);
glVertex3f(140.0,100.0,-315.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(120.0,100.0,-390.0);
glVertex3f(100.0,100.0,-415.0);
glVertex3f(100.0,100.0,-355.0);
glVertex3f(120.0,100.0,-330.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(100.0,100.0,-415.0);
glVertex3f(80.0,100.0,-445.0);
glVertex3f(80.0,100.0,-385.0);
glVertex3f(100.0,100.0,-355.0);
glEnd();
/////////////////////////////////////////////////////////////////////////////////
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,50.0,-360.0);
glVertex3f(160.0,50.0,-365.0);
glVertex3f(160.0,50.0,-305.0);
glVertex3f(180.0,50.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(160.0,50.0,-365.0);
glVertex3f(140.0,50.0,-375.0);
glVertex3f(140.0,50.0,-315.0);
glVertex3f(160.0,50.0,-305.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(120.0,50.0,-390.0);
glVertex3f(100.0,50.0,-415.0);
glVertex3f(100.0,50.0,-355.0);
glVertex3f(120.0,50.0,-330.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(100.0,50.0,-415.0);
glVertex3f(80.0,50.0,-445.0);
glVertex3f(80.0,50.0,-385.0);
glVertex3f(100.0,50.0,-355.0);
glEnd();
////////////////////////////////////////////////////////////////////////
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(180.0,0.0,-360.0);
glVertex3f(160.0,0.0,-365.0);
glVertex3f(160.0,0.0,-305.0);
glVertex3f(180.0,0.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(160.0,0.0,-365.0);
glVertex3f(140.0,0.0,-375.0);
glVertex3f(140.0,0.0,-315.0);
glVertex3f(160.0,0.0,-305.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(140.0,0.0,-375.0);
glVertex3f(120.0,0.0,-390.0);
glVertex3f(120.0,0.0,-330.0);
glVertex3f(140.0,0.0,-315.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(120.0,0.0,-390.0);
glVertex3f(100.0,0.0,-415.0);
glVertex3f(100.0,0.0,-355.0);
glVertex3f(120.0,0.0,-330.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(100.0,0.0,-415.0);
glVertex3f(80.0,0.0,-445.0);
glVertex3f(80.0,0.0,-385.0);
glVertex3f(100.0,0.0,-355.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(60.0,200.0,-315.0);
glVertex3f(80.0,200.0,-330.0);
glVertex3f(100.0,200.0,-300.0);
glVertex3f(80.0,200.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(40.0,200.0,-300.0);
glVertex3f(60.0,200.0,-315.0);
glVertex3f(80.0,200.0,-285.0);
glVertex3f(60.0,200.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(20.0,200.0,-290.0);
glVertex3f(40.0,200.0,-300.0);
glVertex3f(60.0,200.0,-270.0);
glVertex3f(40.0,200.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(0.0,200.0,-285.0);
glVertex3f(20.0,200.0,-290.0);
glVertex3f(40.0,200.0,-260.0);
glVertex3f(20.0,200.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-20.0,200.0,-285.0);
glVertex3f(0.0,200.0,-285.0);
glVertex3f(20.0,200.0,-255.0);
glVertex3f(0.0,200.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-40.0,200.0,-290.0);
glVertex3f(-20.0,200.0,-285.0);
glVertex3f(0.0,200.0,-255.0);
glVertex3f(-20.0,200.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-60.0,200.0,-305.0);
glVertex3f(-40.0,200.0,-290.0);
glVertex3f(-20.0,200.0,-260.0);
glVertex3f(-40.0,200.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-80.0,200.0,-335.0);
glVertex3f(-60.0,200.0,-305.0);
glVertex3f(-40.0,200.0,-270.0);
glVertex3f(-60.0,200.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,200.0,-365.0);
glVertex3f(-80.0,200.0,-335.0);
glVertex3f(-60.0,200.0,-285.0);
glVertex3f(-80.0,200.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,200.0,-385.0);
glVertex3f(-100.0,200.0,-365.0);
glVertex3f(-80.0,200.0,-300.0);
glVertex3f(-100.0,200.0,-330.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(80.0,150.0,-330.0);
glVertex3f(100.0,150.0,-360.0);
glVertex3f(125.0,150.0,-330.0);
glVertex3f(100.0,150.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(60.0,150.0,-315.0);
glVertex3f(80.0,150.0,-330.0);
glVertex3f(100.0,150.0,-300.0);
glVertex3f(80.0,150.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(40.0,150.0,-300.0);
glVertex3f(60.0,150.0,-315.0);
glVertex3f(80.0,150.0,-285.0);
glVertex3f(60.0,150.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(20.0,150.0,-290.0);
glVertex3f(40.0,150.0,-300.0);
glVertex3f(60.0,150.0,-270.0);
glVertex3f(40.0,150.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(0.0,150.0,-285.0);
glVertex3f(20.0,150.0,-290.0);
glVertex3f(40.0,150.0,-260.0);
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-20.0,150.0,-285.0);
glVertex3f(0.0,150.0,-285.0);
glVertex3f(20.0,150.0,-255.0);
glVertex3f(0.0,150.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-40.0,150.0,-290.0);
glVertex3f(-20.0,150.0,-285.0);
glVertex3f(0.0,150.0,-255.0);
glVertex3f(-20.0,150.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-60.0,150.0,-305.0);
glVertex3f(-40.0,150.0,-290.0);
glVertex3f(-20.0,150.0,-260.0);
glVertex3f(-40.0,150.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-80.0,150.0,-335.0);
glVertex3f(-60.0,150.0,-305.0);
glVertex3f(-40.0,150.0,-270.0);
glVertex3f(-60.0,150.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,150.0,-365.0);
glVertex3f(-80.0,150.0,-335.0);
glVertex3f(-60.0,150.0,-285.0);
glVertex3f(-80.0,150.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,150.0,-385.0);
glVertex3f(-100.0,150.0,-365.0);
glVertex3f(-80.0,150.0,-300.0);
glVertex3f(-100.0,150.0,-330.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(80.0,100.0,-330.0);
glVertex3f(100.0,100.0,-360.0);
glVertex3f(125.0,100.0,-330.0);
glVertex3f(100.0,100.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(60.0,100.0,-315.0);
glVertex3f(80.0,100.0,-330.0);
glVertex3f(100.0,100.0,-300.0);
glVertex3f(80.0,100.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(40.0,100.0,-300.0);
glVertex3f(60.0,100.0,-315.0);
glVertex3f(80.0,100.0,-285.0);
glVertex3f(60.0,100.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(20.0,100.0,-290.0);
glVertex3f(40.0,100.0,-300.0);
glVertex3f(60.0,100.0,-270.0);
glVertex3f(40.0,100.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(0.0,100.0,-285.0);
glVertex3f(20.0,100.0,-290.0);
glVertex3f(40.0,100.0,-260.0);
glVertex3f(20.0,100.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-20.0,100.0,-285.0);
glVertex3f(0.0,100.0,-285.0);
glVertex3f(20.0,100.0,-255.0);
glVertex3f(0.0,100.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-40.0,100.0,-290.0);
glVertex3f(-20.0,100.0,-285.0);
glVertex3f(0.0,100.0,-255.0);
glVertex3f(-20.0,100.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-60.0,100.0,-305.0);
glVertex3f(-40.0,100.0,-290.0);
glVertex3f(-20.0,100.0,-260.0);
glVertex3f(-40.0,100.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-80.0,100.0,-335.0);
glVertex3f(-60.0,100.0,-305.0);
glVertex3f(-40.0,100.0,-270.0);
glVertex3f(-60.0,100.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,100.0,-365.0);
glVertex3f(-80.0,100.0,-335.0);
glVertex3f(-60.0,100.0,-285.0);
glVertex3f(-80.0,100.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,100.0,-385.0);
glVertex3f(-100.0,100.0,-365.0);
glVertex3f(-80.0,100.0,-300.0);
glVertex3f(-100.0,100.0,-330.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(80.0,50.0,-330.0);
glVertex3f(100.0,50.0,-360.0);
glVertex3f(125.0,50.0,-330.0);
glVertex3f(100.0,50.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(60.0,50.0,-315.0);
glVertex3f(80.0,50.0,-330.0);
glVertex3f(100.0,50.0,-300.0);
glVertex3f(80.0,50.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(40.0,50.0,-300.0);
glVertex3f(60.0,50.0,-315.0);
glVertex3f(80.0,50.0,-285.0);
glVertex3f(60.0,50.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(20.0,50.0,-290.0);
glVertex3f(40.0,50.0,-300.0);
glVertex3f(60.0,50.0,-270.0);
glVertex3f(40.0,50.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(0.0,50.0,-285.0);
glVertex3f(20.0,50.0,-290.0);
glVertex3f(40.0,50.0,-260.0);
glVertex3f(20.0,50.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-20.0,50.0,-285.0);
glVertex3f(0.0,50.0,-285.0);
glVertex3f(20.0,50.0,-255.0);
glVertex3f(0.0,50.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-40.0,50.0,-290.0);
glVertex3f(-20.0,50.0,-285.0);
glVertex3f(0.0,50.0,-255.0);
glVertex3f(-20.0,50.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-60.0,50.0,-305.0);
glVertex3f(-40.0,50.0,-290.0);
glVertex3f(-20.0,50.0,-260.0);
glVertex3f(-40.0,50.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-80.0,50.0,-335.0);
glVertex3f(-60.0,50.0,-305.0);
glVertex3f(-40.0,50.0,-270.0);
glVertex3f(-60.0,50.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,50.0,-365.0);
glVertex3f(-80.0,50.0,-335.0);
glVertex3f(-60.0,50.0,-285.0);
glVertex3f(-80.0,50.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,50.0,-385.0);
glVertex3f(-100.0,50.0,-365.0);
glVertex3f(-80.0,50.0,-300.0);
glVertex3f(-100.0,50.0,-330.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(80.0,0.0,-330.0);
glVertex3f(100.0,0.0,-360.0);
glVertex3f(125.0,0.0,-330.0);
glVertex3f(100.0,0.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(60.0,0.0,-315.0);
glVertex3f(80.0,0.0,-330.0);
glVertex3f(100.0,0.0,-300.0);
glVertex3f(80.0,0.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(40.0,0.0,-300.0);
glVertex3f(60.0,0.0,-315.0);
glVertex3f(80.0,0.0,-285.0);
glVertex3f(60.0,0.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(20.0,0.0,-290.0);
glVertex3f(40.0,0.0,-300.0);
glVertex3f(60.0,0.0,-270.0);
glVertex3f(40.0,0.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(0.0,0.0,-285.0);
glVertex3f(20.0,0.0,-290.0);
glVertex3f(40.0,0.0,-260.0);
glVertex3f(20.0,0.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-20.0,0.0,-285.0);
glVertex3f(0.0,0.0,-285.0);
glVertex3f(20.0,0.0,-255.0);
glVertex3f(0.0,0.0,-255.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-40.0,0.0,-290.0);
glVertex3f(-20.0,0.0,-285.0);
glVertex3f(0.0,0.0,-255.0);
glVertex3f(-20.0,0.0,-260.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-60.0,0.0,-305.0);
glVertex3f(-40.0,0.0,-290.0);
glVertex3f(-20.0,0.0,-260.0);
glVertex3f(-40.0,0.0,-270.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-80.0,0.0,-335.0);
glVertex3f(-60.0,0.0,-305.0);
glVertex3f(-40.0,0.0,-270.0);
glVertex3f(-60.0,0.0,-285.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,0.0,-365.0);
glVertex3f(-80.0,0.0,-335.0);
glVertex3f(-60.0,0.0,-285.0);
glVertex3f(-80.0,0.0,-300.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,0.0,-385.0);
glVertex3f(-100.0,0.0,-365.0);
glVertex3f(-80.0,0.0,-300.0);
glVertex3f(-100.0,0.0,-330.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,50.0,-410.0);
glVertex3f(-120.0,50.0,-415.0);
glVertex3f(-120.0,50.0,-285.0);
glVertex3f(-100.0,50.0,-280.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-120.0,50.0,-415.0);
glVertex3f(-140.0,50.0,-425.0);
glVertex3f(-140.0,50.0,-295.0);
glVertex3f(-120.0,50.0,-285.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(-140.0,50.0,-425.0);
glVertex3f(-160.0,50.0,-440.0);
glVertex3f(-160.0,50.0,-310.0);
glVertex3f(-140.0,50.0,-295.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(-160.0,50.0,-440.0);
glVertex3f(-180.0,50.0,-460.0);
glVertex3f(-180.0,50.0,-330.0);
glVertex3f(-160.0,50.0,-310.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(-180.0,50.0,-460.0);
glVertex3f(-200.0,50.0,-485.0);
glVertex3f(-200.0,50.0,-355.0);
glVertex3f(-180.0,50.0,-330.0);
glEnd();
...
glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-100.0,0.0,-410.0);
glVertex3f(-120.0,0.0,-415.0);
glVertex3f(-120.0,0.0,-285.0);
glVertex3f(-100.0,0.0,-280.0);
glEnd();

glBegin(GL_QUADS);
glColor3f(1.0,0.0,0.0);
glVertex3f(-120.0,0.0,-415.0);
glVertex3f(-140.0,0.0,-425.0);
glVertex3f(-140.0,0.0,-295.0);
glVertex3f(-120.0,0.0,-285.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(-140.0,0.0,-425.0);
glVertex3f(-160.0,0.0,-440.0);
glVertex3f(-160.0,0.0,-310.0);
glVertex3f(-140.0,0.0,-295.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(-160.0,0.0,-440.0);
glVertex3f(-180.0,0.0,-460.0);
glVertex3f(-180.0,0.0,-330.0);
glVertex3f(-160.0,0.0,-310.0);
glEnd();
...
glColor3f(1.0,0.0,0.0);
glVertex3f(-180.0,0.0,-460.0);
glVertex3f(-200.0,0.0,-485.0);
glVertex3f(-200.0,0.0,-355.0);
glVertex3f(-180.0,0.0,-330.0);
glEnd();
